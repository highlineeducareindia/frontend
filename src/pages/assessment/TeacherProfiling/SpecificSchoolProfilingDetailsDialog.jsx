...
const SpecificSchoolProfilingDetails = lazy(
	() => import('./SpecificSchoolProfilingDetails'),
)

const SpecificSchoolProfilingDetailsDialog = ({ open, onClose, school }) => {
	return (
...
export default SpecificSchoolProfilingDetailsDialog
