...
import { TeacherIRIUploadDefaultExcelColumns } from './teacherIRIConstants'
import { uploadTeacherIRIData } from './teacherFunctions'
import { bulkUploadMandatoryKeys } from '../../../utils/globalConstants'

const BulkUploadTeacherIRI = ({
	modal,
	handleModal,
	refreshList,
	SchoolRowData,
		...
		<Box>
			<FileUploadDialog
				...
				handleExcelDownload={(e) => {
					e.stopPropagation()
					downloadExcel(
						TeacherIRIUploadDefaultExcelColumns,
						'Teacher IRI Template.xlsx',
					)
				}}
				Content={content}
				mandatoryKeys={bulkUploadMandatoryKeys.teacherIRIRecords}
			/>
			<CustomDialog
				...
				onRightButtonClick={() => {
					ErrorMsgsExcelDownload(
						response,
						setDeleteBulkDialog,
						'TeacherIRI Validation Error.xlsx',
					)
				}}
			/>
		</Box>
...
export default memo(BulkUploadTeacherIRI)
